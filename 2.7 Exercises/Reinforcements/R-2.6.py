...
#These are checks of each type of error possible to raise after the added code, to test the exceptions, uncomment the respective line
#print (cc.charge(-78)) #ValueError 
#print (cc.charge ('hello')) #TypeError
#print (cc.make_payment(-10)) #ValueError
#print (cc.make_payment('test')) #TypeError